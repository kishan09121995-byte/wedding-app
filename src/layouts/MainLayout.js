...
import { LayoutDashboard, Users, UtensilsCrossed, Building2, Hotel, DollarSign, Calendar, Image, Share2, Menu, X, LogOut, Heart, Store, Shield, UserCog, FileText, CheckSquare, MapPin, Palette, MessageSquare, } from 'lucide-react';
...
export default function MainLayout() {
    ...
    const renderPage = () => {
        ...
        if ((currentPage === 'hotel-billing' || currentPage === 'budget') && !canViewBilling) {
            return (_jsx("div", { className: "flex items-center justify-center h-screen", children: _jsxs("div", { className: "text-center", children: [_jsx("p", { className: "text-2xl font-bold text-gray-800 mb-2", children: "Access Denied" }), _jsx("p", { className: "text-gray-600", children: "Only admins and coordinators can view billing information" })] }) }));
        }
        switch (currentPage) {
            case 'dashboard':
    ...
    return (_jsxs("div", { className: "flex h-screen bg-gray-50", children: [_jsxs("div", { className: `${sidebarOpen ? 'w-64' : 'w-0'} bg-mauve text-white transition-all duration-300 overflow-hidden flex flex-col`, children: [_jsxs("div", { className: "p-6 border-b border-mauve/50", children: [_jsxs("div", { className: "flex items-center gap-2 mb-2", children: [_jsx(Heart, { className: "w-6 h-6 fill-rose-gold text-rose-gold" }), _jsx("h1", { className: "text-xl font-bold", children: "Kishan & Megha" })] }), _jsx("p", { className: "text-xs text-mauve/70", children: "June 21\u201322, 2026" })] }), _jsx("nav", { className: "flex-1 overflow-y-auto p-4", children: navItems
                            .filter(item => {
                            if (!item.restricted)
                                return true;
