    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-50">
      ...
      <div className="bg-gradient-to-r from-amber-600 to-orange-600 text-white py-8 px-4">
        <div className="max-w-2xl mx-auto text-center">
          <h1 className="text-4xl font-bold mb-2">💍 Groom's Side Registration</h1>
          <p className="text-amber-100">Verify your phone number to access wedding updates</p>
        </div>
      </div>
            ...
            <form onSubmit={handleGenerateOTP} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-amber-500 focus:ring-2 focus:ring-amber-200 transition-all"
                />
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-amber-600 to-orange-600 text-white font-bold py-3 rounded-lg hover:from-amber-700 hover:to-orange-700 disabled:opacity-50 transition-all flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
            ...
            <form onSubmit={handleVerifyOTP} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="000000"
                  maxLength={6}
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-amber-500 focus:ring-2 focus:ring-amber-200 transition-all text-center text-2xl letter-spacing tracking-widest"
                />
                <p className="text-xs text-gray-500 mt-2">
              ...
              <button
                ...
                className="w-full text-amber-600 font-semibold py-2 hover:text-amber-700"
              >
        ...
        {step === 'success' && guestData && (
          <div className="bg-white rounded-lg shadow-lg p-8">
            <div className="text-center">
              ...
              <div className="bg-amber-50 rounded-lg p-6 mb-6 text-left space-y-3">
                <div>
